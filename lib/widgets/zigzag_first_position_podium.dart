...
class ZigzagFirstPositionPodium extends StatelessWidget {
  ...
  const ZigzagFirstPositionPodium({
    Key? key,
    this.background,
    this.circleText,
    this.name,
          ...
          Stack(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  width: circleWidth ?? 105,
                  height: circleHeight ?? 105,
...
class _BottomZigZagClipper extends CustomClipper<Path> {
  @override
